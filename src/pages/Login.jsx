  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', background: 'var(--cream)' }}>
      <div style={{ width: '100%', maxWidth: '420px' }}>
        ...
        <p style={{ textAlign: 'center', fontSize: '12px', color: 'var(--ink-muted)', marginTop: '16px' }}>
          <a href="https://davidbucari-ui.github.io/orevy-solutions/" style={{ color: 'var(--ink-muted)', textDecoration: 'underline' }}>Découvrir Orevy Solutions →</a>
        </p>
      </div>
    </div>
  )
