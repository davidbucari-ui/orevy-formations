...
const BASE = 'https://api.orevy.app/supabase/rh/rest/v1'
...
// Projet Formations yyqpp — blocs audio
...
async function blocsGet(fid) {
  const r = await fetch(`${BASE_F}/formation_blocs?formation_id=eq.${fid}&order=ordre.asc`, { headers: H_F })
